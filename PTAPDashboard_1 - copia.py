...
names = ["Fecha", "Hora Inicio", "Hora Fin", "Altura Inicial [m]", "Altura Final [m]", "Tiempo [min]", "Volumen [m3]", "Volumen [gal]", "Volumen acumulado [m3]", "Volumen acumulado [gal]", "Tiempo acumulado [min]", "Total Purgas Captadas"]
...
names = ["Fecha", "Hora Inicio", "Hora Fin", "Altura Inicial [m]", "Altura Final [m]", "Tiempo [min]", "Volumen [m3]", "Volumen [gal]", "Volumen acumulado [m3]", "Volumen acumulado [gal]", "Tiempo acumulado [min]", "Total Purgas Bombeadas"]
...
names = ["Fecha", "Hora Inicio", "Hora Fin", "Lectura Inicial", "Lectura Final", "Turbidez [NTU]", "Color [Pt-Co]", "pH", "Tiempo [min]", "Volumen [m3]", "Volumen [gal]", "Tiempo Acumulado [min]", "Volumen Acumulado [m3]", "Volumen Acumulado [gal]"]
...
names = ["Numero", "Fecha", "Volumen Teórico [m3]", "% Uso", "Peso [Ton]", "Capacidad [m3]"]
...
# Crea el dropdown de los meses
#mesDD2 = dfCLR.loc[:,"Fecha"]
#for i in range(0, len(mesDD2)):
#    mesDD2[i] = mesDD2[i].month

#mesDD = list(dict.fromkeys(mesDD))
#print(mesDD)
...
app.layout = html.Div([
    dbc.Row([
    dbc.Col(html.H1("Resumen del Sistema de Deshidratación de Lodos - Geosoluciones SAS - Área de PTAP - Refinería de Barrancabermeja", style={'textAlign':'center'}), width=12)
    ]),
    dbc.Row(html.Hr()),
    dbc.Row(html.H2(['Resumen Diario'])),
    dbc.Row([
        dbc.Col(dcc.Dropdown(id='Dia',
    ...
    dbc.Row([
        dbc.Col(dbc.Row(badgePurgCapt)),
        dbc.Col(dcc.Graph(id='purg-capt-dia')),
        dbc.Col(dbc.Row(badgeBomb)),
        dbc.Col(dcc.Graph(id='bomb-dia')),
    ]),
    dbc.Row([
        dbc.Col(dbc.Row(badgeVolCapt)),
        dbc.Col(dcc.Graph(id='vol-capt-dia')),
        dbc.Col(dbc.Row(badgeVolRet)),
        dbc.Col(dcc.Graph(id='vol-ret-dia')),
    ]),
    dbc.Row([
        dbc.Col(dbc.Row(badgepHdia)),
        dbc.Col(dcc.Graph(id='pH-dia')),
        dbc.Col(dbc.Row(badgeturbdia)),
        dbc.Col(dcc.Graph(id='turb-dia')),
        dbc.Col(dbc.Row(badgecolordia)),
        dbc.Col(dcc.Graph(id='color-dia')),
        dbc.Col(dbc.Row(badgePrctAguaTrat)),
        dbc.Col(dcc.Graph(id='agua-trat-dia')),
    ]),
    dbc.Row(html.Hr()),
   dbc.Row(html.H2(['Resumen Mensual'])),
    dbc.Row([
        dbc.Col(dcc.Dropdown(id='Mes', # PONER DROPDOWN DINÁMICO DEPENDIENDO DE LAS FECHAS
                 options=[{'label':x, 'value':x}
                          for x in meses],
                 value=9
                 )),
    ...
    dbc.Row([
        dbc.Col(dbc.Row(badgePurgCapt)),
        dbc.Col(dcc.Graph(id='purg-capt-mes')),
        dbc.Col(dbc.Row(badgeBomb)),
        dbc.Col(dcc.Graph(id='bomb-mes')),
    ]),
    dbc.Row([
        dbc.Col(dbc.Row(badgeVolCapt)),
        dbc.Col(dcc.Graph(id='vol-capt-mes')),
        dbc.Col(dbc.Row(badgeVolRet)),
        dbc.Col(dcc.Graph(id='vol-ret-mes')),
        dbc.Col(dbc.Row(badgeDiasTra)),
        dbc.Col(dcc.Graph(id='dias-mes')),
    ]),
    dbc.Row([
        dbc.Col(dbc.Row(badgepHdia)),
        dbc.Col(dcc.Graph(id='pH-mes')),
        dbc.Col(dbc.Row(badgeturbdia)),
        dbc.Col(dcc.Graph(id='turb-mes')),
        dbc.Col(dbc.Row(badgecolordia)),
        dbc.Col(dcc.Graph(id='color-mes')),
        dbc.Col(dbc.Row(badgePrctAguaTrat)),
        dbc.Col(dcc.Graph(id='agua-trat-mes')),
    ]),
    dbc.Row([
        dbc.Col(dcc.Graph(id='mi-mes-vol'), width=6),
        dbc.Col(dcc.Graph(id='mi-mes-prop'), width=6),
    ]),
    ...
    dbc.Row([
        dbc.Col(dbc.Row(badgePurgCapt)),
        dbc.Col(dcc.Graph(id='purg-capt-acum')),
        dbc.Col(dbc.Row(badgeBomb)),
        dbc.Col(dcc.Graph(id='bomb-acum')),
    ]),
    dbc.Row([
       dbc.Col(dbc.Row(badgeVolCapt)),
        dbc.Col(dcc.Graph(id='vol-capt-acum')),
        dbc.Col(dbc.Row(badgeVolRet)),
        dbc.Col(dcc.Graph(id='vol-ret-acum')),
        dbc.Col(dbc.Row(badgeDiasTra)),
        dbc.Col(dcc.Graph(id='dias-acum')),
    ]),
    dbc.Row([
        dbc.Col(dbc.Row(badgepHdia)),
        dbc.Col(dcc.Graph(id='pH-acum')),
        dbc.Col(dbc.Row(badgeturbdia)),
        dbc.Col(dcc.Graph(id='turb-acum')),
        dbc.Col(dbc.Row(badgecolordia)),
        dbc.Col(dcc.Graph(id='color-acum')),
        dbc.Col(dbc.Row(badgePrctAguaTrat)),
        dbc.Col(dcc.Graph(id='agua-trat-acum')),
    ]),
    dbc.Row([
        dbc.Col(dcc.Graph(id='mi-acum-vol')),
        dbc.Col(dcc.Graph(id='mi-acum-prop')),
    ]),

    dbc.Row(html.H2(['Resumen Geotube'])),
    dbc.Row([
    dbc.Col(dcc.Dropdown(id='numGTDD',
                         options=[{'label': x, 'value': x}
                                  for x in numGTdd],
                         value=6
                         )),
    dbc.Col(dcc.Dropdown(id='fechaGTDD',
                         options=[],
                         #value='13/09/2021'
                         )),
    ]),
    ...
    dbc.Row([
        dbc.Col(dcc.Graph(id='fig-GT')),
        dbc.Col(dcc.Graph(id='fig-uso-GT')),
    ]),
...
def mes_interactivo(value_mes, value_unidades):
...
def acum_interactivo(value_mes,value_unidades):
    # --------------------------------- Módulo 3 ------------------------------------------
    print(value_unidades)
    ...
    prctOutacum = 0.73
    galOutCLRacum = galInCLRacum * 60 * 24 * prctOutacum * 30.5 * len(meses)
...
def Geotube_interactivo(value_fechaGT, value_numGT):
    # --------------------------------- Módulo 4 ------------------------------------------
